...
import { LUNGS_ICON, PULSE_ICON, WARNING_ICON } from "../constants/icon.constants";
...
import { FirstAccordionContent, SecondAccordionContent, ThirdAccordionContent } from "./homepageAccordionContent";
                ...
                <Box className="grid lg:grid-cols-2 gap-12 items-center w-full">
                        ...
                        <Box className="space-y-4">
                            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-tight flex gap-4">
                                ...
                                <Box as="span" className="relative">
                                    ...
                                    <Box as="span" className="absolute -bottom-2 left-0 right-0 h-1 bg-secondary/30 rounded-full"></Box>
                                </Box>
                            </h1>
                            <BlockquoteComponent image="https://icon2.cleanpng.com/20180607/hrb/kisspng-university-of-sydney-brain-and-mind-centre-darling-5b18f2227c7ba0.7750607215283615065099.jpg" subject="University of Sydney" quote="Spinal fusion is the riskiest type of surgery for back pain." />
                        </Box>
                    </Box>
                    ...
                    <Box className="lg:pl-12">
                        <Box className="bg-white/8 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 border border-white/10">
                            <ButtonCollapsible Type="single" RootClass="space-y-3 sm:space-y-4" Data={accordionDataItem}  />
                        </Box>
                    </Box>
                </Box>
            </Box>

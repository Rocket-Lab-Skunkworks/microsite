        ...
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-gray-900' : 'bg-transparent' }`}>
            <Box className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <Box className="flex justify-between items-center h-16 md:h-20">
                    <Link href="#" className="flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-secondary/50 rounded-lg p-1">
                        <LOGO_ICON width="24" height="24" className="text-secondary" />
                        <Box as="span" className="text-xl font-bold">
                            <Box as="span" className="text-white">Know</Box>
                            <Box as="span" className="text-secondary">Before</Box>
                            <Box as="span" className="text-white">You</Box>
                            <Box as="span" className="text-secondary">Go</Box>
                        </Box>
                    </Link>

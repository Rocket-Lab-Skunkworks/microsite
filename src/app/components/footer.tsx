                    ...
                    <Box className="space-y-4" style={{opacity: 1, transform: 'none'}}>
                        <Box className="bg-gray-50 p-4 rounded-lg">
                            <Text className="text-sm text-gray-600">
                                <Box as="span" className="font-bold">Important Disclaimer:</Box>
                                {" "} The goal of this website is to support patients in seeking second opinions and fully understanding their recovery options. It provides general health information based on peer-reviewed research and publicly available evidence. This content is not a substitute for professional medical advice, diagnosis, or treatment. Always consult qualified healthcare professionals regarding your specific circumstances.
                            </Text>
                        </Box>

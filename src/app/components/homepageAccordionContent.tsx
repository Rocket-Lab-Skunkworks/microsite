...
export const FirstAccordionContent = () => {
  return (
    <Box className="mt-2 p-3 sm:p-4 bg-white/3 rounded-xl border border-white/5">
      <Text as="p" className="text-gray-300 mb-2 text-sm sm:text-base">
        Including infection, nerve damage, and blood clots
      </Text>
      <Link
        href="https://www.sydney.edu.au/medicine-health/news-and-events/news/2022/04/12/orthopaedic-surgeries-doing-more-harm-than-good.html"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center text-secondary hover:text-secondary/80 text-sm gap-1.5 transition-colors"
      >
